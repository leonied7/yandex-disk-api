...
class File extends Item
{
    ...
    {
        return $this->getBuilder()->upload($stream)->exec()->isSuccess();
    }
    ...
    {
        return $this->getBuilder()->download($stream, $from, $to)->exec()->isSuccess();
    }
    ...
    {
        return $this->getBuilder()->getPreview($size, $stream)->exec()->isSuccess();
    }
